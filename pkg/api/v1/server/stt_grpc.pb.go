...
func (c *sttServiceClient) StreamingRecognize(ctx context.Context, opts ...grpc.CallOption) (SttService_StreamingRecognizeClient, error) {
	stream, err := c.cc.NewStream(ctx, &SttService_ServiceDesc.Streams[0], "/v1.server.SttService/StreamingRecognize", opts...)
	if err != nil {
		return nil, err
	}
...
var SttService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "v1.server.SttService",
	...
	Metadata: "pkg/api/v1/server/stt.proto",
}
